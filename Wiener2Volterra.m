...
function varargout=Wiener2Volterra(delays,A,k0,k1,k2,k3,k4,k5)
...
case 6 % third order
    ...
    R3=size(k3,1);
    varargout{1}=k0+k02f(k2,A);
    varargout{2}=[k1;zeros(R3-R1,1)]+[zeros(delays(3),1);k13f(k3,A);zeros(R1-R3-delays(3),1)];%h1
    varargout{3}=k2;%h2
    varargout{4}=k3;%h3
