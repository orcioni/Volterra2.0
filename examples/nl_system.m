...
function  out = nl_system(x)
B = [0.2264190,   0.8539435,   1.0243269,   0.1957670,  -0.3426567,  -0.0456011, 0.1097026,  -0.0088268,  -0.0177919,   0.0047174];
out = filter (B, 1, x);
out = 4.5./(1+2*exp(-out))-4.5/3;
end
