...
mseyn02 = test_sigma2(Vkernel02, 2, 0.2,1.6, 'volt2_system');
mseyn04 = test_sigma2(Vkernel04, 2, 0.2,1.6, 'volt2_system');
mseyn08 = test_sigma2(Vkernel08, 2, 0.2,1.6, 'volt2_system');
mseyn16 = test_sigma2(Vkernel16, 2, 0.2,1.6, 'volt2_system');

mseyn_n2 = test_sigma2(Vkernel_n2, 3, 0.2,1.6, 'volt2_system');
