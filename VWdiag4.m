                ...
                if (ind(4)>ind(3)) & (ind(3)>ind(2)) & (ind(2)>ind(1)) 
                    ...
                    Sgm1=sgm1+1;Sgm2=sgm2+1;Sgm3=sgm3+1;Sgm4=sgm4+1;
                     diag4(Sgm4,Sgm3,Sgm2,Sgm1)=1/24/A4* mean(...
                        ...
                        p2.*...
                        p3.*...
                        [zeros(sgm4,1);xn(os:end-sgm4-delay)].*...
                        yn(os+delay:end)                          )...
                        -1/12/A*(...
                        k2(Sgm2,Sgm1)*(sgm3==sgm4)...
                       +k2(Sgm3,Sgm1)*(sgm2==sgm4)...
                       +k2(Sgm4,Sgm1)*(sgm2==sgm3)...
                       +k2(Sgm3,Sgm2)*(sgm1==sgm4)...
                       +k2(Sgm4,Sgm2)*(sgm1==sgm3)...
                       +k2(Sgm4,Sgm3)*(sgm1==sgm2)...
                                 )...
                        -1/24/A2*k0*(...
                        (sgm1==sgm2)*(sgm3==sgm4)+...
                        (sgm1==sgm3)*(sgm2==sgm4)+...
